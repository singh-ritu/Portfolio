...
const Button = ({
  ...
  const baseStyles = "font-semibold rounded-lg border border-gray-200 shadow-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200";
